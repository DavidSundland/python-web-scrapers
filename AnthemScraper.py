...
if answer == "y" or answer == "Y":
    with open('../scraped/anthemusedlinks.csv', 'r') as previousscrape: 
...
csvFile = open('../scraped/AnthemScrapes.csv', 'w', newline='') #The CSV file to which the scraped info will be copied.  NOTE - need to define the 'newline' as empty to avoid empty rows in spreadsheet
...
if answer == "y" or answer == "Y":
    ...
    linksFile = open('../scraped/AnthemUsedLinks.csv', 'w', newline='') #Save the list of links to avoid redundancy in future scraping
